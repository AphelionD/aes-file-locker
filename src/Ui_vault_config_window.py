...
class Ui_MainWindowVaultConfig(object):
    def setupUi(self, MainWindowVaultConfig):
        ...
        self.gridLayout.addWidget(self.filePathToolButton, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.filePathReminder, 6, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButton, 7, 1, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.gridLayout.addWidget(self.hintLabel, 2, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.vaultPathToolButton, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.vaultPathEdit, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.filePathEdit, 5, 1, 1, 1)
        ...
        self.VaultNameEdit.textChanged['QString'].connect(MainWindowVaultConfig.checkVaultSettingsValidity) # type: ignore
        self.vaultPathEdit.textChanged['QString'].connect(MainWindowVaultConfig.checkVaultSettingsValidity) # type: ignore
        self.filePathEdit.textChanged['QString'].connect(MainWindowVaultConfig.checkVaultSettingsValidity) # type: ignore
    ...
    def retranslateUi(self, MainWindowVaultConfig):
        ...
        self.filePathReminder.setText(_translate("MainWindowVaultConfig", "解密文件夹路径不合法！其上级目录必须存在"))
        ...
        self.filePathLabel.setToolTip(_translate("MainWindowVaultConfig", "<html><head/><body><p>解密文件夹路径的上级目录应该是一个合法目录</p></body></html>"))
        ...
        self.hintLabel.setText(_translate("MainWindowVaultConfig", "如果密码库和解密文件夹路径相同，加密文件将会与您的解密文件放在一起，请您不要改动加密相关的文件。如果设置为不同的路径，密码库路径请您选择一个空文件夹或者选择已加密的密码库文件夹。"))
